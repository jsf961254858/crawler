...
public class ZtFangRentQuery extends QueryBase {
	...
	public String toQuerySql(){
		String sql="select id, url, ptyname, price, traffic, agent, agenttel, creation_date, is_cleaned, modification_date from zt_fang_rent where 1=1";
	...
	public String toCountSql(){
		String sql="select count(*) from zt_fang_rent where 1=1";
