...
public class ZtAnjukeSaleQuery extends QueryBase {
	...
	public String toQuerySql(){
		String sql="select id, spiderid, scheduleid, url, price, ptyname, layout, inch, direction, unitprice, high, type, deco, description, agent, tel, modification_date, creation_date, is_cleaned from zt_anjuke_sale where 1=1";
	...
	public String toCountSql(){
		String sql="select count(*) from zt_anjuke_sale where 1=1";
