...
public class ZtFangEsfQuery extends QueryBase {
	...
	public String toQuerySql(){
		String sql="select id, url, ptyname, price, traffic, agent, agenttel, creation_date, is_cleaned, modification_date from zt_fang_esf where 1=1";
	...
	public String toCountSql(){
		String sql="select count(*) from zt_fang_esf where 1=1";
